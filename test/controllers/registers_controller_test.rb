...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { Emailid: @register.Emailid, Firstname: @register.Firstname, Gender: @register.Gender, Lastname: @register.Lastname, Phoneno: @register.Phoneno } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { Emailid: @register.Emailid, Firstname: @register.Firstname, Gender: @register.Gender, Lastname: @register.Lastname, Phoneno: @register.Phoneno } }
